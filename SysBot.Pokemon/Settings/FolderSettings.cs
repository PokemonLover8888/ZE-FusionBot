...
public class FolderSettings : IDumper
{
    ...
    [Category(Files), Description("Directory of the curated genuine-tracker Vault (Collector's Shelf) PKM files."), DisplayName("Vault Folder")]
    public string VaultPKMFolder { get; set; } = string.Empty;
